...
```text
/investigate-microcosm-target --release microcosm-us-2024-incumbent-improved-996401a-20260618 irs_soi.ty2022.historic_table_2.us.under_1.ctc_amount
```
...
- `microcosm-ledger-auditor` - verifies ledger/source target semantics.
