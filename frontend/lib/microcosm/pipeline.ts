// The microcosm-US dataset-creation pipeline, as implemented in
// PolicyEngine/microcosm (derived from main @ 98d990b, 2026-07-02).
//
// Structure mirrors the code, not an idealized diagram:
// - Source enrichment stages come verbatim from
//   packages/microcosm-build/src/microcosm/build/us/source_stages.json — the
...
export const PIPELINE_PHASES: PipelinePhase[] = [
    ...
    steps: [
      {
        ...
        description:
          "policyengine/microcosm-us · microcosm_us_2024.h5 — the previous release is the base population (records, imputations, and structure are inherited; only weights are refit).",
      },
      {
        id: "ledger_facts",
      ...
      },
      {
        ...
        code: "microcosm/build/us/fiscal_target_references.json",
        description:
    ...
    steps: [
      {
        ...
        code: "microcosm.build.us_runtime.fiscal_targets.compile_us_fiscal_target_registry",
        description:
    ...
    steps: [
      {
        ...
        code: "microcosm.calibrate.calibrate / calibrate_l0_refit",
        description:
    ...
    steps: [
      {
        ...
        description: "Writes microcosm_us_2024.h5 with the calibrated weights.",
        artifacts: ["microcosm_us_2024.h5"],
      },
      {
        ...
        artifacts: ["microcosm_us_2024_calibration.npz"],
      },
      {
      ...
      },
      {
        ...
        code: "microcosm.build.us_runtime.reform_validation",
        description:
      ...
      },
      {
        id: "demographics",
        title: "Demographics",
        code: "microcosm.build.us.demographics",
      ...
      },
      {
        ...
        code: "microcosm.calibrate.diagnostics.write_calibration_diagnostics",
    ...
    steps: [
      {
        ...
        code: "microcosm.build.staging.StagingTelemetry → policyengine/microcosm-us-staging",
        description:
  ...
  },
  {
    ...
    steps: [
      {
        id: "publish_release",
        title: "microcosm-publish-release",
        code: "microcosm.data.publish_cli (tools/publish_release.sh wrapper)",
        description:
