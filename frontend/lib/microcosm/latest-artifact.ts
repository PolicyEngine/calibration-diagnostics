...
// live from the policyengine/microcosm-us Hugging Face dataset, resolved through
...
export const MICROCOSM_HF_REPO = process.env.MICROCOSM_HF_REPO ?? "policyengine/microcosm-us";
export const MICROCOSM_HF_REVISION = process.env.MICROCOSM_HF_REVISION ?? "main";
...
const COUNTRY_REPO: Record<MicrocosmCountry, { repo: string; revision: string }> = {
  ...
  uk: {
    repo: process.env.MICROCOSM_UK_HF_REPO ?? "policyengine/microcosm-uk-private",
    revision: process.env.MICROCOSM_UK_HF_REVISION ?? "main",
  },
};
...
// --- name decomposition (matches microcosm.dev's parse_target) ---------------
