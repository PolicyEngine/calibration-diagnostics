...
// The dashboard chrome, skinned to microcosm.dev. We deliberately do NOT use
...
// exit from microcosm.dev. The shell stays transparent so the site atmosphere
// (app/globals.css body::before + .site-grain) shows through, and the header /
// footer come from the microcosm.dev-style components.
