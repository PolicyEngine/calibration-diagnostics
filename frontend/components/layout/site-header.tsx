...
// microcosm.dev-style top bar for the mounted dashboard.
//
// Replaces the ui-kit <Header>, which read as a hard context switch out of
// microcosm.dev (issue #99). Carries a breadcrumb back up to the calibration
// strategy essay and the site home, plus the site's editorial nav voice.
//
// Links that point back into microcosm.dev (home, /calibration, /papers, hash
...
// resolves to microcosm.dev/calibration. next/link / withBasePath are reserved
