...
// A single-SVG flow diagram of the microcosm-US pipeline. Hand-laid layout —
// the node set mirrors lib/microcosm/pipeline.ts (derived from the microcosm
...
const NODES: Node[] = [
  ...
  { id: "chronicle", x: 235, y: 330, w: 170, h: 46, title: "Chronicle facts", sub: "IRS · Census · CMS · JCT…", kind: "input" },
  ...
  { id: "publish", x: 1180 - 160, y: 480, w: 240, h: 56, title: "microcosm-publish-release", sub: "guards → HF tag → latest.json → Slack", kind: "publish" },
];
  ...
  return (
    <div className="overflow-x-auto">
      <svg
        ...
        role="img"
        aria-label="microcosm dataset pipeline flow diagram"
      >
        <defs>
          <marker
            id="arrow"
