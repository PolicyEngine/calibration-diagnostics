"""Parser for storage/calibration_targets/aca_spending_and_enrollment_2025.csv.

Identical schema/semantics to the 2024 file, with period=2025.
"""
...
SOURCE_PATH = "storage/calibration_targets/aca_spending_and_enrollment_2025.csv"
PERIOD = 2025
    ...
    with csv_path.open() as f:
        ...
        for i, row in enumerate(reader):
            ...
            out.append(TargetRecord(
                ...
                source_row=row_key,
                notes="ACA marketplace enrollment (PTC recipients), 2025",
            ))
            out.append(TargetRecord(
                variable="aca_ptc",
                geo_level="state",
